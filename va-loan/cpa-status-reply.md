# Draft reply to SingerLewak (CPA) — status, signatures, prior years

> Send to **Michelle Lamb** (msweedler@singerlewak.com) and **Asiia Taylor**
> (ataylor@singerlewak.com). This one email does four jobs: updates your email,
> signs off, sends what Michelle asked for on 6/10, and pins them to a written
> status + timeline. Fill every `[BRACKET]`.

---

**To:** msweedler@singerlewak.com; ataylor@singerlewak.com
**Subject:** 2025 Returns + Engagement Letters — signing, prior years, and a status request

Hi Michelle and Asiia,

Thank you both — and apologies for the delay on my end. Let me get everything moving at once.
