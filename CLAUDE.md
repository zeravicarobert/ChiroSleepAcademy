...
- **Dr. Deed Harrison DC (CBP / Ideal Spine founder)** — Robert met him at a Parker seminar in Las Vegas (most recent Parker attended), pitched CSA at his booth, walked him through the mental model + clinical protocol + business model + vision. Dr. Deed said "email me." Robert has his email as `drdeed@idealspine@gmail.com` — **but that format is malformed (two `@` signs); verify correct email before sending.** Likely `drdeed@idealspine.com` (Ideal Spine has its own domain) or `drdeed.idealspine@gmail.com`. **Strategic significance:** Dr. Deed leads a national CBP-certified DC network. Referral pathway proposed: CBP-certified DC screens patient with CSA Sleep & Airway Screening Questionnaire → if positive for UAOSA (Upper Airway Obstructive Sleep Apnea), schedule 4-way Zoom (Dr. Deed + referring CBP DC + Dr. Z + patient) → patient enters CSA Structural UAOSA Recovery Program (~$25K). Offer document drafted at `offers/csa-uaosa-program.md`. **Outreach email to Dr. Deed not yet drafted/sent — pending verified email address.**
...
- **CSA Sleep & Airway Screening Questionnaire** — referenced as an existing or in-development CSA asset; not yet documented in repo. Used by referring DCs to screen patients into the UAOSA pathway. *Open todo: produce the actual questionnaire.*
