# CLAUDE.md — ChiroSleepAcademy Project Memory

This file is the long-term memory for the Chiropractic Sleep Academy (CSA)
project. Every Claude session in this repo should read it first and use it
to stay aligned across sessions.
...
> so different sessions were reading different memories, and neither had the
> whole picture. This file is the union of all 32, section by section. Details
> of the fork and the full branch inventory:
> `repo-audit/2026-08-30-branch-audit.md`.
>
> **Sections 16–29 were reachable from only one or two branches before today.**
> Numbers 16–19 had been reused for *different* content on each line; every
> distinct section survived here under a new number, so a cross-reference
> written before 2026-08-30 may point at the wrong number — trust the section
> *title*, not the number, in older documents.
...
- **§17** — Mentor Ecosystem
- **§18** — Mentor & Education Investment Tracking
- **§19** — Patient-Facing Offer Architecture (Ecosystem Spine)
- **§20** — Patient-Facing Funnel (Parallel Track — added 2026-07-15)
- **§21** — Positioning Decisions (living log)
- **§22** — Legal / Compliance Counsel (Ecosystem Proofreader)
- **§23** — Products & the Practitioner Dispensary (decided 2026-08-21)
- **§24** — Upcoming Commitments (rolling — update as they pass)
- **§25** — Watch List (monitor, don't act)
- **§26** — ChatGPT Archive Migration (active project)
- **§27** — Reconciliation with the July 10 Master Summary (added 2026-07-16)
- **§28** — How Robert wants Claude to write (2026-07-16)
- **§29** — Operator Profile — Robert (background & biography)
...
Full structural definition, asset map, and gap list: **`CSA_STRUCTURE.md`**.
As of 2026-08-18, Pillar 3 is the least built and the highest leverage — it is
a contact list, not yet a network.
...
- **"Showcase to the world"** positions Robert as the visible proof of
  the missing layer (live-the-model-first pattern — see the Operator
  Profile section). Robert is the demonstration, not just the claimant.
- **When to use which:**
...
### The potluck vision (canonical positioning metaphor)

There was no table for what Robert does, so he built one — *"there was no
table for me, so I created one."* CSA's posture toward the healthcare world
is a **potluck**: many tables, each bringing a real dish. CSA's table is the
**first table** — early intervention (breathing, rest, structure): come here
first, before things harden. Patients are then free to go to the other tables
(physician, dentist, surgeon) and take what they genuinely need — and free to
pass a dish by (CPAP, oral appliance, drug, surgery) when it isn't wanted or
needed. No attacks, no pressure either way. Early intervention first;
everything else by real need, never by fear.

CSA works **from its own table, on its own convictions** — setting its own
table for believers rather than seeking a seat at the secular medical table.
No attacks on other providers (see §5); no seeking their approval either.
This frame is how CSA relates to other providers without cowering and without
attacking.
...
Make Structural Airway Chiropractic a recognized category, and give the
chiropractors who want to practice it a clear model, real training, and
...
Primary audience (ideal members):
- SOT, AK, CFR, CBP, and posture-focused chiropractors
- Airway-aware chiropractors already curious about sleep
- DCs who want a structural answer to sleep complaints

Strategic partners:
- Airway-aware dentists / dental sleep professionals
- HST providers, CBCT imaging providers
- CE partners, sleep-adjacent vendors

Patients are the downstream beneficiary, but the direct customer is the DC.
...
- Conviction-led — CSA sets its own table; it does not seek a secular seat
  or trim convictions to earn one
- No hype, no fear-based marketing, no internet-bro energy
- No attacks on MDs, DDS, ENTs, sleep medicine, CPAP, or oral appliances —
  and convictions are never softened to win their approval
...
- Claim VAET or chiropractic cures sleep apnea
...
> **RETIRED red line (corrected 2026-06-26, reaffirmed 2026-07-17):** the old
> bullet *"Imply DCs diagnose OSA — they don't; the role is structural"* is
> **wrong and retired.** In California the Doctor of Chiropractic has the
> **same legal authority to diagnose and manage** sleep apnea, snoring, and
> insomnia. Do not subordinate it. The accurate boundary is in the scope note
> below.
>
> **Scope of the "Attack MDs / sleep medicine" line:** it protects the
> **individual** MD/DDS/ENT peers CSA collaborates with — it is **NOT** a gag
> on stating documented fact about the **AMA as an institution** (e.g., the
> *Wilk v. AMA* antitrust finding). Naming an adjudicated ruling is fact, not
> an attack.
...
at 0%. `JULY_2026_GOALS.md` and `AUGUST_2026_GOALS.md` were created on
2026-07-23 (the six unfinished May goals carried forward and redistributed),
but have not been maintained either. The 90-day goals in section 10 came due
**August 31, 2026** and none of the three are demonstrably met. Do not paper
over this; when Robert opens a session, the honest next task is usually either
closing a 90-day gap or writing the next monthly tracker. Don't create one
unprompted — offer it.
...
narrow **practitioner dispensary** model — see §23.
...
Dr. Z as case manager / quarterback for a high-ticket, doctor-led case plan.
...
section 22) — do not present HSA/HRA eligibility in marketing copy until
...
3. Deliver Letter of Engagement to the active mentee
4. Hold 2 Zoom calls with DCs about their sleep
5. Bring 1 DC to Hot Springs for VAET treatment
6. Launch landing page / website by May 17
...
1. **Clear public-facing offer.** A simple offer a DC can understand and
   say yes to — clear name, promise, audience, price/next step, CTA.
2. **Active real outreach** to ideal DCs and strategic partners
   (SOT, AK, CFR, CBP, airway-aware DCs, dental sleep pros, HST/CBCT/referral
   partners). Goal is live conversations, not perfection.
3. **One working funnel** — a single path from stranger to conversation:
   outreach → free educational resource → Zoom → CSA offer.
...
Specifically:
1. **The category is clear.** People understand "Structural Airway Chiropractic."
2. **The offer is clear.** A simple way for DCs to join, learn, consult, or get help.
3. **The funnel is working.** Outreach → content → call → paid offer or partnership.
4. **A first cohort or inner circle exists.** A small group of serious DCs has joined.
5. **Strategic partners are forming.** Dentists, HST, CBCT, CE, airway vendors.
6. **The content library is real.** Workbook, emails, pages, videos, diagrams.
7. **Revenue has started.** Real sales, even if early.
...
Across sessions, Claude should:

1. **Remember the brand.** Chiropractic Sleep Academy, Structural Airway
   Chiropractic, VAET, skull-down sleep-first thinking.
2. **Keep focus.** Don't let Robert drift into too many ideas at once.
3. **Write like Robert.** Clear, direct, educational, doctor-teacher voice.
4. **Protect credibility.** No cure claims, no attacks, no hype.
5. **Build real assets.** Pages, landing pages, emails, outreach messages,
   course content, diagrams, funnel copy.
6. **Help with code and GitHub.** Site files, repo structure, docs, deploys.
7. **Push toward market-facing action**, not endless brainstorming.

Hats Claude wears: strategist, editor, developer, brand guardian,
...
real solutions. Listed under §29 software stack as future work.
...
> **Note (2026-08-30):** this map reflects one branch's view of the repo.
> The repository actually spans many unmerged branches holding ~309 distinct
> files; see `repo-audit/2026-08-30-branch-audit.md` for the full inventory.
...
### 14.8 Imported ChatGPT master summaries (source docs, not trackers)

> These files live on `claude/rob-peter-csa-agreement-lr88yc` and are not
> present on every branch. All were imported 2026-07-11 and preserved
> verbatim. They are source documents, not live trackers, and none is
...
- `CSA_PETER_PROJECT_CONTEXT.md` — companion reference (imported from a ChatGPT
  ...
  and an explicit **the Master Summary's own §20, "Working Principles for Claude Code"** (18 rules — keep
...
### 14.9 Files and directories recorded on other branches

> Consolidated 2026-08-30 from every branch's own §14. Many of these files
> live on branches that are not yet merged (see
> `repo-audit/2026-08-30-branch-audit.md`), so a path here may not exist on
> the branch you are working on. Check before assuming.
...
- `/site` — the public site. `/content` — course/educational assets.
  ...
  practitioner dispensary policy, §23).
...
- `/schedule` — itineraries and calendar reconciliation.
- `/policy` — standing policies of record (e.g. the practitioner dispensary
  policy, §23).
- `/strategy` — durable strategy assets. `csa-evidence-plan.md` is the plan for
  generating AHI/CBCT outcome data that survives peer review.
- `/clinical` — chairside clinical forms and protocols. Holds the **VAET New
  Patient Initial Evaluation & Examination** (`vaet-initial-evaluation.md`,
  master source) plus a generated print-ready HTML and its build script. See
  `clinical/README.md`. Edit the markdown, never the HTML.
- `reference/tpa-insurance-primer.md` — TPA / insurance teaching notes + glossary.

### 14.10 Canonical-source precedence

> **⭐ `PROJECT_MASTER_SUMMARY.md`** (on `claude/sleep-disorder-patient-funnel-cyu76i`)
> is Robert's authoritative strategic summary, status **July 10, 2026**. Where it
> conflicts with an older section of this file on **strategy, clinical framework,
> terminology, pricing intent, or sequencing**, it wins. This `CLAUDE.md` is the
> *operational* memory — accounts, file and tracker locations, working agreements,
> current state — and wins on those. Read §27 for the reconciliation and the open
> strategic questions before acting on older material.

- `content/csa-vaet-modulation-framework.md` — canonical language and
  reasoning guide for all CSA/VAET claims. Ported from the Google Doc
  "CSA-VAET Modulation Framework for Claude Code." Treat it as binding
  alongside sections 4 and 5.
- `repo-audit/2026-08-30-branch-audit.md` — read-only survey of all 68
  branches: what each holds, the 2026-05-21 memory fork, and the
...
- **Stay-at-Home 12-Module Program** — pricing, delivery format (live cohort? on-demand? Zoom?), enrollment cadence, refund policy. Currently undefined (§19).
- **Protect Your Income (SDI certification) pricing** — Mandossian's blueprint estimates $400 initial certification + $525 ongoing coaching = $1,925 LTV with referral revenue. Confirm Robert's actual fees and CA telehealth scope (§19).
- **Mike Barron video team scope** — which assets are first in queue (Hot Springs/VAET, SDI telehealth, Stay-at-Home modules)? (§17).
- **Dr. Deed Harrison DC (CBP / Ideal Spine founder)** — Robert met him at a Parker seminar in Las Vegas (most recent Parker attended), pitched CSA at his booth, walked him through the mental model + clinical protocol + business model + vision. Dr. Deed said "email me." **Confirmed email (5/27/26): `drdeed@idealspine.com`.** **Strategic significance:** Dr. Deed leads a national CBP-certified DC network. Referral pathway proposed: CBP-certified DC screens patient with CSA Sleep & Airway Screening Questionnaire → if positive for UAOSA, schedule 4-way Zoom (Dr. Deed + referring CBP DC + Dr. Z + patient) → patient enters CSA Structural UAOSA Recovery Program (~$25K). Offer document: `offers/csa-uaosa-program.md`. Screening questionnaire: `forms/csa-sleep-airway-screening-questionnaire.md`. **Outreach email to Dr. Deed not yet drafted/sent — next step.**
- **UAOSA** — Upper Airway Obstructive Sleep Apnea (Robert's preferred specificity; differentiates from central sleep apnea, which VAET does not address)
- **CBP** — Chiropractic BioPhysics, Dr. Deed Harrison's methodology, focused on posture and structural alignment
- **AACP** — American Academy of Craniofacial Pain. Robert's reference standard for dental partners; AACP-certified dentists (or equivalent) handle the bite + oral airway component of the CSA treatment plan
- **CSA Sleep & Airway Screening Questionnaire** — first draft created 5/27/26 at `forms/csa-sleep-airway-screening-questionnaire.md`. Combines validated instruments (STOP-BANG, Epworth Sleepiness Scale) with CSA's original structural-airway screen. Triggers RED/YELLOW/GREEN stratification. Used by CBP-certified DCs (and any referring clinician) to screen patients into the CSA UAOSA pathway. **Before deployment: have reviewed by sleep physician AND/OR healthcare attorney for clinical/legal soundness; produce a digital version (Typeform / JotForm / ClickFunnels) and a fillable PDF.**
...
adjacent educators. Each is described below. See also §18 for the
...
- Lanes he covers:
  ...
  - Marketing for Robert as a **Telehealth provider for CA W2 workers**
    seeking certification for **CA EDD SDI** claims (§19).
...
- Direct-response marketing legend in his own lane. Simon Severino's
  ...
  (§17, Mentor 2), so Jay's framing already touches Robert's work
...
- Investment to date: **$5,000** (see §18).
...
in lifetime investment math and ROI accounting (§18).
...
- **Eleanor — Bitcoin / blockchain.** $1,500. Course runs late
  May 2026 (see §24). Robert is in active learning mode.
...
- **Santiago (a.k.a. Isaiah)** — same person, two names Robert uses
  ...
  through end of May 2026 per §17 Mentor 1). With Peter in San
  Diego ~6/3–6/4/26 after the retreat ends. Crew member Robert is
  counting on for the 8/14 win condition (§24, item #3).
...
- **Steve McNeal** — Robert's friend; **owner of Death Valley Hot
  Springs Resort** (the venue Robert uses for VAET — see §29
...
**Strategic asset: Robert's USMC background (§29).** 9 years USMC
...
why §29 (operator profile) is not background trivia — it is the
...
- **Mike Barron's video team (§17)** produces marketing assets for
...
- **CA DC = case manager of the sleep case.** In California the Doctor of
  ...
  sleep apnea, snoring, and insomnia (see "equal authority" in §28). So the **CA DC
...
3. **Isaiah (a.k.a. Santiago — §17) is a productive crew member**
...
Max is not choosing to be in the summer plan. See §29 family —
handle with care.
...
- **Protect Your Income / SDI (patient-facing, §19):** Alex's lane.
...
- **Stay-at-Home 12-Module Program (§19):** No active mentor lane;
...
EDD growth (§20). The recent **patient-facing work** (the EDD/SDI sleep email +
the `/funnel` patient ecosystem, see §23 above) is therefore the **secondary
...
> the current priority / outcomes-data engine. See §21 for the decision and its
...
Per Simon Severino's instruction (§17), Claude should keep asking
...
2. CSUN / Pepperdine
3. USMCR — 9 years (Force Recon, 3D ANGLICO; see §29 Military service)
...
- **Sep 4-6, 2025 — Anarchapulco / Apatin, Serbia** (= same event
  ...
  again 2026; see §24 travel calendar for the 2026 leg)
...
- **VA service-connected disability (§19 Channel B, as of 5/22/26):**
...
foundation of **Channel B** in the patient ecosystem (§19): helping
...
4. **Financial** (one specific financial priority: filing his own USMC
   service-connected disability claim with the VA — see §19 Channel B
   and §29 live-the-model-first pattern)
...
- **Chiro 3.0 — Telehealth delivery.**
  - **3.1** = Time off work from illness, injury, or burnout (Mental
    Financial Stress entry point — §19)
...
- **Anarchapulco / Liberpulco** — Jeff Berwick's community. Robert is
  ...
  is a possible attendance window in August 2026 (§24). Peter
  may meet him there.
...
- **SimpleTalk** — inbound/outbound AI call agent.
  - **SimpleTalk phone number:** **818-408-4495** (confirmed 6/12/26).
    ...
    flagged as "underutilized" in §29 below, now being deployed
    operationally via SimpleTalk. **Conversion of underutilized
    asset → active operational tool.**
  - **Deployment partner:** **Ayssia** (Santiago's girlfriend, §17
...
- **818 cellphone number** — **now being deployed via SimpleTalk
  as of 6/12/26** (818-408-4495). See §29 software stack above.
...
- **Isaiah = Santiago** (confirmed 5/26/26). Specific role still
  ...
  bodywork retreat (§17 Mike Barron), or a different kind of crew
  member? Confirm.
