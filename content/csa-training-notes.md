# CSA Training Notes (curriculum teaching points)

For use later in **CSA training** — mostly **CSA 1.0 (Anatomy & Physiology)**.
Draft teaching points from Robert. Hypothesis-level items are flagged so copy
stays inside the red lines (teach as "CSA's model under investigation," not
proven fact).
...
- separates two pressure environments
- is compliant
- transmits rhythmic forces
- moves by deformation, not rotation
- regulates flow without acting as a valve

**Now compare the palatine bones.** They sit between pressure environments
(nasal above, oral below), they are (when healthy) compliant, they can transmit
rhythmic cranial/respiratory motion, they move by small deformation rather than
rotation, and they shape airflow without being a valve.
...
- Human performance is limited not by capacity, but by how much rigidity has
  replaced compliance.

**Curriculum home:** these feed **CSA 1.0 — Anatomy & Physiology** (compliance,
the cranial pump, palate/diaphragm mechanics, fluid dynamics).
