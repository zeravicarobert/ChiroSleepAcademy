...
(biomechanics + scope), and how dentists can **help more patients in less chair time**
— without turf wars, over-education, or wasted effort.

> **You don't have to run the playground. You just need to know where to stand.**

---

## Part 1 — The Opportunity (and the Bottleneck)
Sleep apnea patients are entering dental offices more than ever. Dentists are often
the **first** to open the airway conversation — you already screen airway, CBCT gives
you visual authority, and the first apnea conversation feels natural in a dental
...
Most of these aren't device problems. They're **global-mechanics problems** the
device alone can't solve.

## Part 2 — Why CBCT and the Appliance Alone Aren't Enough
CBCT shows airway narrowing, jaw position, craniofacial anatomy — a **local** view.
It does not show spinal-curve load, pelvic imbalance, respiratory mechanics, postural
compensation, or foot–spine relationships.

> **A narrow airway is a local finding. Sleep apnea is a global condition.**

When the global frame isn't addressed, an oral appliance is being placed on a body
...
- **pelvis & SIJ** (SOT / AK),
- **cranial mechanics** (BNS / CFR),
- **spinal loading**,
- **foot–pelvis–spine integration.**

This answers one question that protects your appliance work:

> *Will an oral appliance help — or create new problems — without correcting global
> mechanics?*
...
selection is best made as a **co-decision:**
- **DDS** evaluates dental tolerance (occlusion, perio, restorations, TMJ).
- **DC** evaluates biomechanical consequences (posture, cervical load, cranial/pelvic
  response).

Both providers trained on the device. The appliance **supports the structure — it
doesn't replace it.**

## Part 5 — The Ideal Sequence (clean, ethical, efficient)
...
## Part 6 — The Chair-Hour Math (why this pays you back)
Co-management doesn't add work — it **removes** the chair hours that airway cases
usually cost:
...
- **Shared documentation** — the DC's structural findings and re-tests support your
  chart and interdisciplinary record.
...
2. **Agree on the sequence** above and a simple referral pathway (form + shared
   summary).
3. **Pilot 3–5 cases** with pre/post HST so you both see the difference.
4. **Standardize** the co-decision checklist (Appendix B) for every airway patient.

---

## Appendices
**A. Referral snapshot (DDS → DC).** Patient, airway concern, CBCT note, appliance
being considered, question for the DC ("can the body accept/hold this device?").
