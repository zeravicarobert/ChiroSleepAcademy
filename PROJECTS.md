# PROJECTS — Operational Dashboard

> **Last updated:** 2026-05-27
> **Update cadence:** Touch this file after any significant project
> movement. Sunday weekly review is the natural anchor.
> **Companion file:** `CLAUDE.md` (narrative context for every
> project listed here). `MAY_2026_GOALS.md` for current-month tracker.

---

## ⏰ URGENT — clock-driven, not optional

| Project | % | Next action | Deadline |
|---|---|---|---|
| **🚨 Child Support call — Mon 6/1/26 8:00 AM PT** (license suspension cure) | 0% | **SET PHONE ALARM TONIGHT FOR 7:30 AM PT 6/1.** Robert's explicit 5/29/26 commitment: 6/1 8 AM call Child Support, speak to rep, make payment or document prior payments, request letter for CA Chiropractic Board, deliver letter to Board, confirm license good past 6/17/26. Full breakdown: `legal/active-paperwork.md` Subcategory 1. June goals tracker: `JUNE_2026_GOALS.md`. | **6/1/26 8 AM PT call → 6/17/26 license deadline** |
| **🔥 IRS combined liability — ~$434K across 4 tax years (2013/2014/2016/2018)** | 0% | **MAJOR REVISION 5/28/26.** Not one $48K letter — FOUR tax years with combined ~$434K exposure. 2014 alone is $369,147.52. Active collection posture (11/10/25 Urgent Notice letters on 2014/2016/2018; LT40 4/14/26 on 2013). **At this scale, tax attorney > Enrolled Agent.** CA State Bar referral. Bring all letters. Do NOT contact IRS directly without representation. Possible Offer in Compromise + collection-statute defense on 2013/2014. Full breakdown: `legal/active-paperwork.md` Subcategory 4. | Pre-levy (IRS can act anytime) |
| **CA Franchise Tax Board — ~$13,500 combined** (Vehicle Reg + 2019 Tax) | 0% | $658 vehicle reg ($224 negotiable penalty) + $12,842 Tax Year 2019 ($3,075 negotiable penalty). Tax attorney handling IRS can negotiate FTB simultaneously. Penalty abatement often available for reasonable cause. Full breakdown: `legal/active-paperwork.md` Subcategory 5. | Coordinate with IRS engagement |
| **Dusanka unclaimed property claim** (deceased mother) | 0% | Letter from CA State Controller 4/15/26. Property at Farmers & Merchants Bank of Long Beach. Email draft + claim guidance at `outreach/2026-05-28-dusanka-unclaimed-property.md`. Need: Dusanka's death certificate, Robert's birth certificate, photo ID. | No hard deadline; SCO claims take 90-180 days |
| **Election ballots (2) — Statewide Direct Primaries** | 0% | Mail in before 6/2/26. Located in Legal Paper Stack. | **6/2/26 (5 days)** |
| **X-Ray License revocation** (Radiologic Health Branch) | 0% | License expired 1/31/25; revocation notice 8/8/25. Decision: reinstate (call 916-327-5106) or formally retire? Most DCs refer X-rays out, so possibly tolerable. Record #RHC 00167120. | Decision needed |
| **LA County property tax 2025-2026** | 0% | Annual obligation. 888-807-2111 / ttc.lacounty.gov. Pay on schedule. | Per LA County schedule |
| **Malpractice Renewal application** | 0% | Paper form, fill out by hand, fax/email. ~30-60 min. Knock out before 6/1. Full breakdown: `legal/active-paperwork.md` Subcategory 2. | Before suspension date |
| **Vet status question — fill YES on Board forms** | 0% | YES (USMC 9 yrs — Force Recon, ANGLICO). Unlocks CA fee waivers + expedited processing. Both Consumer Affairs + Chiropractic Board ask because they share intake infrastructure. Full breakdown: `legal/active-paperwork.md` Subcategory 3. | This week |
...
| **1st CSA Mentee: Dr. Vanessa Manfredi, DC** | Active | Robert flagged needs help with her. **Open: what's her current status in the CSA pathway, what specifically needs help, what's the next step?** Likely 1st Vol 2 student. | Robert to clarify |
| **1st SDI-Telehealth Mentee: Dr. Vernell Lucas, DC** | NEW 5/28/26 | Lucas raised his hand + opted in TODAY for mentorship on building a CA EDD SDI telehealth practice. **This is a different track than CSA Certification (Vol 1/Vol 2)** — focuses on SDI / Channel A practice-building, not Structural Airway / VAET. **Open: scope of mentorship, curriculum, price, time commitment, CA licensure verified, source of his inbound interest.** | Robert to clarify + onboard |
...
## 🎯 8/14 WIN CONDITION — Robert's own five items

By 8/13/26, these five things should be true for "I did this summer right":

| # | Item | % | Next action |
|---|---|---|---|
| 1 | Real time with Zac + Adelaide | 0% | Kids arrive Vegas 6/2 6:40 PM. Plan activities for the pre-school weeks. |
| 2 | Mike Barron marketing plan live + producing revenue | 5% | Lane paused; resumes when video crew returns end of May. |
| 3 | Isaiah/Santiago productive crew member | 10% | Confirmed on video crew. Activate when crew returns. |
| 4 | Peter making introductions for Robert's message | 10% | Peter departs 6/16. Pre-departure window: identify which intros to ask for. |
| 5 | VAET at Tecopa positioned with paid clients | 10% | Offer + screening questionnaire drafted ✓. Next: Dr. Deed warm intro to open referral lane. |

**Overall: ~7%.** Most movement happens June-August.

---

## 🏗️ ACTIVE BUILD — multi-week workstreams

### CSA (Doctor-Facing) — Simon's lane
...
| **SDI-Telehealth Mentorship Track** (NEW — separate from CSA Certification) | 0% | Robert teaches DCs to build a CA EDD SDI telehealth practice modeled on his own. Different curriculum than CSA Vol 1/Vol 2 (which is about Structural Airway + VAET). 1st mentee Dr. Vernell Lucas DC opted in 5/28/26. **Open scope: curriculum design, pricing, format, prerequisites (CA-licensed DC?), CE-credit eligibility, how this track relates to the enrollment ramp (June 1 / July 3 / Sept 5 — does Lucas count toward those numbers, or is the ramp CSA-only?). Possibly a separate Vol structure or its own pedagogical model.** |
...
| Component | % | Next action |
|---|---|---|
| Robert's own VA SCD claim filing | 0% | See URGENT section above |
| VA C&P credentialing question | 0% | Determine: does Robert get credentialed, or work with VSOs / credentialed providers? |
| Veteran community outreach mechanism | 0% | Undefined |
| Channel B pricing | 0% | Undefined |

### Stay-at-Home 12-Module Program (the spine)

| Component | % | Next action |
|---|---|---|
| Architecture | 100% | Defined in §17 |
| Pricing | 0% | Robert's decision |
...
|---|---|---|
| **Dr. Tom Cowan MD** | ✅ SENT 5/27/26 via website contact form | Await response ~2 weeks; if none, log + move on |
| **Dr. Deed Harrison DC** | Email confirmed (`drdeed@idealspine.com`); not yet sent | Draft warm re-intro email referencing Parker conversation |
...
| **Dr. Adam Del Torto DC — NOT a warm outreach target** | DO NOT contact | At the end of an annual CFR seminar, Del Torto **publicly screamed at Robert** in front of remaining attendees, claiming that Robert's double-ballooning was illegal. **Context update 5/29/26:** Other DCs and people have told Robert that Del Torto is jealous of him; Robert understands Del Torto to be bipolar — the screaming may have been a mental-health-driven episode rather than a substantive professional dispute. This reframes the *cause* but not the *recommendation*: still do NOT initiate outreach. If his name surfaces in CFR-related discussions, treat as historical context only and avoid public engagement. |

---

## 🎓 EDUCATION + CADENCE

| Program | % | Cadence | Next |
|---|---|---|---|
| Eleanor — Bitcoin/Blockchain (5 days) | 20% | Tue/Thu/Fri this week + Mon/Tue next week, 6-8:30 PM PT | Thu 5/28 — topic: mining |
| Regis Realm / Warrior2King / Parasite Protocol | Active | Mondays | Continue |
| SupraHuman (physical) | Active | TBD | Continue |
| Anarchapulco / Liberpulco interest | Aspirational | Aug Serbia event | Decide attendance closer to date |
| Mike Maloney (gold/silver education via Peter) | Active reading | Self-paced | Continue |
| Jay Abraham e-books | Pending | On the "continue reading" list | Pull from email/Drive |

---

## 💰 MENTOR + ROI TRACKING

Full table in CLAUDE.md §20. Lifetime mentor capital identified
~$124K + recurring (Russell Brunson ~$400/mo + ClickFunnels). $0
measured ROI to date. Weekly review on Sundays: "what did this
mentor's work produce or save this week?"
...
| Tai Lopez (dormant) | ❓ Unclear | Unknown |
...
## 🏆 PATHFINDER MASTERMIND — Oct 1–4, Mill Valley

| Component | % | Status |
|---|---|---|
| Ticket purchased | 100% | $3,000 Tier 1 paid 5/22 |
| Directory profile (Unique Ability + Core Business Issue) | 95% | Submitted ✓ |
| Quote verification (Nestor *Breath*) | 80% | Verify exact wording in Robert's copy |
| Headshot final | 50% | Cap photo submitted as provisional; upgrade with crew in June |
| Flight + Fri/Sat dinner planning | 0% | Q3 work |

---

## 🏥 HEALTH / SELF-CARE / DAILY
...
## 📐 ARCHITECTURE ONLY — defined but not started
...
- **CE/certification path for CSA** (does CSA pursue CE credit?)
- **Tecopa proposal template** (a written one-pager for the VAET trial)
- **Lead magnet** for the CSA funnel
- **HST vendor decision** (Sleep Doctor margin tension)

---

## 📂 WHERE THE FULL CONTEXT LIVES

For deeper context on any project above, follow these pointers:

| Project area | File(s) |
|---|---|
| CSA category + offer + positioning | `CLAUDE.md` §1–8 |
| Mentor stack + ROI | `CLAUDE.md` §16, §20; `mentors/` |
| Patient ecosystem (Channels A + B) | `CLAUDE.md` §17 |
| Robert's operator profile | `CLAUDE.md` §19 |
| Pathfinder commitment | `CLAUDE.md` §18 |
| Dr. Deed Harrison + UAOSA program | `offers/csa-uaosa-program.md`; `CLAUDE.md` §15 |
| CSA Screening Questionnaire | `forms/csa-sleep-airway-screening-questionnaire.md` |
| Tom Cowan outreach | `outreach/2026-05-26-tom-cowan-md.md` |
| Eleanor Bitcoin class | `education/blockchain-academy-eleanor-2026-notes.md`; `relationships/eleanor-bitcoin-cohort.md` |
| Mandossian's PYI blueprint | `mentors/mandossian-2026-protect-your-income-blueprint.md` |
| Current-month tracker | `MAY_2026_GOALS.md` |