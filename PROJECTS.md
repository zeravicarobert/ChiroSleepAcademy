...
|---|---|---|---|
| **Child Support letter → CA Chiropractic Board** (HARD DEADLINE: **6/17/26 = suspension start**) | 0% | Call Child Support office today; request letter confirming current status. Same day: call CA Chiropractic Board to confirm cure mechanism, clarify license renewal independence, and ask if a new Notice of Receipt of Release is needed (vs the prior 1/12/26 one). Forward letter via certified mail + email + fax. Full breakdown: `legal/active-paperwork.md` Subcategory 1. | 6/17/26 |
